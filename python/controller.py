...
class Controller:
    ...
    def detect_screenshot():
        # New gesture: index, middle, and ring fingers up, others down
        screenshot_condition = (Controller.index_finger_up and 
                               Controller.middle_finger_up and 
                               Controller.ring_finger_up and 
                               Controller.little_finger_down and 
                               Controller.Thump_finger_down)
        
        # Check if we need to take a screenshot
        if not Controller.screenshot_taken and screenshot_condition:
            ...
            Controller.screenshot_taken = True
            print(f"Screenshot taken: {filename}")
        
        # Reset the flag when the gesture is no longer detected
        elif not screenshot_condition:
            Controller.screenshot_taken = False